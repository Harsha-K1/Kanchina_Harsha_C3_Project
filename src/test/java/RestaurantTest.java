...
class RestaurantTest {
    ...
    @BeforeEach
    public void setup() {
        buildNewRestaurantForTest();
        MockitoAnnotations.openMocks(this);
        mockedRestaurant = restaurant;
    }

    public void buildNewRestaurantForTest(){
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        Restaurant spiedRestaurant = Mockito.spy(mockedRestaurant);
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(LocalTime.parse("15:30:00")); //mocking currentTime method return value.
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant spiedRestaurant = Mockito.spy(mockedRestaurant);
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(LocalTime.parse("23:00:00")); //mocking currentTime method return value.
